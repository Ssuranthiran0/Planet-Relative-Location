...
def index():
    ...
    if request.method == 'POST':
        ...
        if planet:
            ...
            true_anomaly = main.calculateAngle(mean_anomaly, planet[main.ECCENTRICITY])

            print(f"Mean Anomaly      Radians: {mean_anomaly:.3e}    Degrees: {main.degrees(mean_anomaly):.3e}")
            print(f"True Anomaly      Radians: {true_anomaly:.3e}    Degrees: {main.degrees(true_anomaly):.3e}")
